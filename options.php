        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td>
                    ...
                    <p>Enter domain names that this WordPress instance needs to communicate with. Separate multiple domains by commas. Delimiters are not needed for regular expressions since they are put in for your ('/'). For information about regular expressions please go to <a href="http://www.regular-expressions.info">http://www.regular-expressions.info</a>.</p>
                </td>
            </tr>
        </table>
        <?php submit_button(); ?>
